...
(D042, accepted in D043). D044 adds a bounded Android-launch rendering budget and mobile PR coverage; technical validation is in progress and physical-device acceptance remains open. No in-route freeze root cause is established.
...
| M1 — Reliability diagnosis and focused repairs | Partial: D043 memory initiative accepted; D044 Android-launch slice in technical validation. Independent freeze investigation, physical lower-end evidence, House 1 voice reproduction and I08 loading-strategy comparison remain open. | I01/I04 diagnosis can begin now. Measure before choosing resource fixes or eliminating staged loading. Each repair needs evidence. |
...
| 2026-09-23 | F19 / I04 / R01 | Mobile texture/framebuffer/light budget, first-frame loading gate, renderer/context error recovery and production-build mobile PR matrix. | [Report and validation](../../../../docs/reports/shepherd-adventure-mobile-rendering.md); D044. Full browser/CI validation in progress. | No physical-device or player-facing acceptance inferred. | [Draft PR #13](https://github.com/JesusFilm/story-lab/pull/13); I04/M1 remain partial. |
...
Status: implemented, technical validation in progress in draft PR #13; human
playtest remains open. No release or unrelated roadmap completion is implied.
