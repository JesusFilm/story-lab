...
export class HouseSighting {
 constructor(){this.started=false;this.elapsed=0;this.page=0;this.complete=false;}
 ...
 advance(){if(this.phase!=='conversation')return false;if(this.page<3)this.page++;else this.complete=true;return true;}
