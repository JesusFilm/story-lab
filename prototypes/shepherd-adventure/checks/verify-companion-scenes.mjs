...
for(let i=0;i<2000&&j.travel;i++){j.step(.05);if(j.travel)assert(j.travel.speed>=4.39);}
...
console.log('Companion scenes passed: opening order, skip endpoint, stationary gate watch, single follow choice, continuous run, pause and reset.');
