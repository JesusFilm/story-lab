...
await page.waitForFunction(()=>window.routeRehearsal.getState().audio.night?.loaded.length===5);
...
console.log('PASS browser: five real MP3s decoded, workshop ignition once, no runtime errors.');
