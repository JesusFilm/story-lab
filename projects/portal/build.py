...
write('index.html', page('Play', f'''<section class="intro"><span class="eyebrow">A collection of experiments</span><h1>Step into a story.</h1><p>Small journeys through biblical worlds. Choose a prototype and start exploring.</p></section><section id="prototypes" class="prototype-grid" aria-label="Playable prototypes">{''.join(cards)}</section><a class="library-link" href="library/"><div><span class="eyebrow">Behind the scenes</span><h2>The pieces of the world</h2><p>Turn the models around and read the prompts that shaped their reference art.</p></div><span class="action">Explore 9 assets ↗</span></a>'''))
asset_cards = []
...
write('library/index.html', page('Asset library', '<section class="intro"><span class="eyebrow">Behind the scenes</span><h1>The pieces of the world.</h1><p>Nine models from the prototypes, with their generated reference art and original prompts.</p></section><section class="asset-grid" aria-label="Asset library">'+''.join(asset_cards)+'</section>', '../'))
write('.nojekyll', '')
