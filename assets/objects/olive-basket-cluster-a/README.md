...
- [Reference](olive-basket-cluster-a-reference.png) · [exact ImageGen prompt](olive-basket-cluster-a-reference-prompt.txt)
- [Original selected model](olive-basket-cluster-a-pixal3d-source.glb)
- [Prepared model](runtime/olive-basket-cluster-a-pixal3d-runtime.glb)
